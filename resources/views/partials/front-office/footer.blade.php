        ...
        <div class="xb-contact-form">
            <div class="row g-0 mt-none-30">
                <div class="col-lg-7 mt-30">
                    <div class="xb-inner">
                        <h5 class="xb-item--sub-title"><span><img src="assets/img/footer/contact.svg" alt=""></span> Contact Us</h5>
                ...
                <div class="col-lg-5 mt-30">
                    <div class="footer-apps">
                        ...
                        <div class="xb-item--holder text-center">
                            ...
                            <p class="xb-item--content">Don't miss out! Download now for seamless functionalities and endless possibilities.</p>
