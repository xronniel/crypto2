...
<div class="container pt-4">
    ...
    <!-- Form to Create News -->
    <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data" class="mb-4" onsubmit="return document.activeElement.id !== 'article-tags-input';">
        @csrf
        <div class="row">
            <!-- Category -->
        ...
        <!-- Tags Section -->
        <x-tag-input :existing-tags="$existingTags" name="tags" label="Tags" id="article-tags" />
