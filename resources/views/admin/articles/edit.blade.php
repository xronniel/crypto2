    ...
    <form action="{{ route('admin.articles.update', $article) }}" method="POST" enctype="multipart/form-data" class="mb-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="state" class="form-control" id="state" value="{{ old('state', $article->state) }}" required>
            </div>

            <!-- Country -->
            <div class="col-md-6 mb-3">
                <label for="country">Country:</label>
                <input type="text" name="country" class="form-control" id="country" value="{{ old('country', $article->country) }}" required>
            </div>
        </div>
