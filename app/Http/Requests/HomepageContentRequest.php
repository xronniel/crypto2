...
class HomepageContentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'mobile_hero_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
            ...
            'requirements_icon1' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
            'requirements_icon1_title' => 'nullable|string|max:255',
            'requirements_icon1_text' => 'nullable|string',
            'requirements_icon2' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
            'requirements_icon2_title' => 'nullable|string|max:255',
            'requirements_icon2_text' => 'nullable|string',
            'requirements_icon3' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
            ...
            'features_card1_icon' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
            'features_card1_text' => 'nullable|string',
            'features_card2_title' => 'nullable|string|max:255',
            'features_card2_icon' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
            'features_card2_text' => 'nullable|string',
            'features_card3_title' => 'nullable|string|max:255',
            'features_card3_icon' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
            'features_card3_text' => 'nullable|string',
            'features_card4_title' => 'nullable|string|max:255',
            'features_card4_icon' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
